...
export interface HttpInstance {
  ...
  post<T = unknown>(url: string, data?: unknown, config?: HttpRequestConfig): Promise<ApiResponse<T>>
  put<T = unknown>(url: string, data?: unknown, config?: HttpRequestConfig): Promise<ApiResponse<T>>
